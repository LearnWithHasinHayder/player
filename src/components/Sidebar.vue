        ...
        <ul class="episodes">
          <li class="flex items-center cursor-pointer justify-between group" v-for="(episode, epindex) in chapter.episodes" :key="episode.uuid">
            <div class="flex items-center">
              ...
              <span :class="{ 'text-orange-400': episode.playing, 'text-gray-400': !episode.playing }" @click="setCurrentEpisode(chapter.episodes[epindex])" class="text-gray-400 text-lg group-hover:text-gray-300">{{ episode.title }}</span>
            </div>
